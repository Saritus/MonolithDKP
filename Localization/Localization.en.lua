...
core.L = {
  ...
  BELT = "Belt",
  BESTPRACTICES = "Please remember to remove MonolithDKP. You can either wait for a full broadcast or rename World of Warcraft\\_classic_\\WTF\\Account\\<account id>\\SavedVariables\\MonolithDKP.lua to MonolithDKP.lua and continue using the addon",
  BID = "Bid",
  ...
  OUTOFDATEANNOUNCE = "Your version of Monolith DKP is out-of-date. Please update on Curse/Twitch to ensure there are no compatibility issues.",
  ...
  CHANGELOG1 = "- Fully forked from MonolithDKP to MonolithDKP including databases",
